...
const PricingCard = ({ pkg, isFullPackage = false }: { pkg: typeof instagramPackages[0]; isFullPackage?: boolean }) => (
...
const Pricing = () => {
  return (
    <>
      <Helmet>
        <title>Pricing - Trivio Digital | Social Media Marketing Packages</title>
        <meta name="description" content="Transparent pricing for social media management. Choose from Instagram-only or full social media packages. Start growing your brand today." />
      </Helmet>
        ...
        <section className="py-16 lg:py-24 bg-gradient-to-b from-background via-secondary/10 to-background">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Focused Instagram growth for businesses that want to dominate the platform.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-24">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Complete multi-platform management for maximum reach and engagement.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {fullPackages.map((pkg) => (
                <PricingCard key={pkg.name} pkg={pkg} isFullPackage />
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="py-16 lg:py-24 bg-gradient-to-b from-background via-primary/5 to-background">
          <div className="container mx-auto px-4 lg:px-8 text-center">
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-2xl mx-auto">
              Book a free strategy call with our team. We'll analyze your current presence 
              and recommend the perfect package for your goals.
            </p>
